...
assert.match(shopee, /SHOPEE_REGION_MODEL_PRICE_RATIO_LIMITS[\s\S]*SG:\s*5[\s\S]*TW:\s*5[\s\S]*TH:\s*5[\s\S]*PH:\s*5[\s\S]*BR:\s*4/, 'Shopee adapter must encode observed region price ratio limits');
