...
for (const token of [
  ...
  'function mrEbayDescriptionTable',
  'Album product information',
  'Hello, K-pop collector',
  'What is included',
  'Handling before shipment',
  'International shipping time guide',
  'Economy / Standard',
  'Expedited',
  'Customs, Duties & Taxes',
  'For buyers in the United States (DDP Service)',
  'Guaranteed Landed Cost',
  'Zero Hidden Fees',
  'For international buyers (Europe, Asia, Australia, Canada & More)',
...
for (const token of [
  ...
  'async function ensurePolicies(marketplaceId: string, lifecycleState?: unknown)',
