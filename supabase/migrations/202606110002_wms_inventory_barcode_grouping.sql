-- WMS import barcode grouping: when selected WMS rows share one official
-- barcode, stage them as one master source group. Individual option SKUs stay
-- exactly as WMS provides them.

drop function if exists public.stage_wms_inventory_payload(jsonb);
